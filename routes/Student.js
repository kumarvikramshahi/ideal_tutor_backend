...
const { getStudentProfile, patchStudentProfile } = require('../controllers/Profile/Student');
const { postTeachSession, fetchTeachSession, patchTeachSession } = require('../controllers/Session/TeachSession/TeachSession');
const { getStudentList } = require('../controllers/PartialFetch/StudentList');
...
router.get('/profile/fetch/student/', getStudentProfile);

router.patch('/profile/edit/student/',
    patchStudentProfile
);
